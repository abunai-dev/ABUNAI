 ...
 * </p>
 * <ul>
 *   <li>{@link dev.abunai.confidentiality.analysis.model.uncertainty.pcm.impl.BehaviorUncertaintySourceImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link dev.abunai.confidentiality.analysis.model.uncertainty.pcm.impl.BehaviorUncertaintySourceImpl#getScenarios <em>Scenarios</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BehaviorUncertaintySourceImpl extends UncertaintySourceImpl implements BehaviorUncertaintySource {
	...
	protected EClass eStaticClass() {
		return PcmPackage.Literals.BEHAVIOR_UNCERTAINTY_SOURCE;
	}
		...
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PcmPackage.BEHAVIOR_UNCERTAINTY_SOURCE__TARGET, oldTarget, target));
			}
		}
		return target;
	}
	...
	public void setTarget(SetVariableAction newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PcmPackage.BEHAVIOR_UNCERTAINTY_SOURCE__TARGET, oldTarget, target));
	}
	...
	public List<BehaviorUncertaintyScenario> getScenarios() {
		if (scenarios == null) {
			scenarios = new EObjectContainmentEList<BehaviorUncertaintyScenario>(BehaviorUncertaintyScenario.class, this, PcmPackage.BEHAVIOR_UNCERTAINTY_SOURCE__SCENARIOS);
		}
		return scenarios;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PcmPackage.BEHAVIOR_UNCERTAINTY_SOURCE__TARGET:
