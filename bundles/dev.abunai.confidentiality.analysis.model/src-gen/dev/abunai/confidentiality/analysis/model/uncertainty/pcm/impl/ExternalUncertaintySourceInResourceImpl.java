 ...
 * </p>
 * <ul>
 *   <li>{@link dev.abunai.confidentiality.analysis.model.uncertainty.pcm.impl.ExternalUncertaintySourceInResourceImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link dev.abunai.confidentiality.analysis.model.uncertainty.pcm.impl.ExternalUncertaintySourceInResourceImpl#getScenarios <em>Scenarios</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExternalUncertaintySourceInResourceImpl extends ExternalUncertaintySourceImpl implements ExternalUncertaintySourceInResource {
	...
	protected EClass eStaticClass() {
		return PcmPackage.Literals.EXTERNAL_UNCERTAINTY_SOURCE_IN_RESOURCE;
	}
	...
	public List<ExternalUncertaintyScenarioInResource> getScenarios() {
		if (scenarios == null) {
			scenarios = new EObjectContainmentEList<ExternalUncertaintyScenarioInResource>(ExternalUncertaintyScenarioInResource.class, this, PcmPackage.EXTERNAL_UNCERTAINTY_SOURCE_IN_RESOURCE__SCENARIOS);
		}
		return scenarios;
	}
