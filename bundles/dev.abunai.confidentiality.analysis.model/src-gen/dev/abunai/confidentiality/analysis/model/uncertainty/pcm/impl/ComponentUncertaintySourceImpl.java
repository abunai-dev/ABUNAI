 ...
 * </p>
 * <ul>
 *   <li>{@link dev.abunai.confidentiality.analysis.model.uncertainty.pcm.impl.ComponentUncertaintySourceImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link dev.abunai.confidentiality.analysis.model.uncertainty.pcm.impl.ComponentUncertaintySourceImpl#getScenarios <em>Scenarios</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ComponentUncertaintySourceImpl extends UncertaintySourceImpl implements ComponentUncertaintySource {
	...
	protected EClass eStaticClass() {
		return PcmPackage.Literals.COMPONENT_UNCERTAINTY_SOURCE;
	}
		...
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PcmPackage.COMPONENT_UNCERTAINTY_SOURCE__TARGET, oldTarget, target));
			}
		}
		return target;
	}
	...
	public void setTarget(AssemblyContext newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PcmPackage.COMPONENT_UNCERTAINTY_SOURCE__TARGET, oldTarget, target));
	}
	...
	public List<ComponentUncertaintyScenario> getScenarios() {
		if (scenarios == null) {
			scenarios = new EObjectContainmentEList<ComponentUncertaintyScenario>(ComponentUncertaintyScenario.class, this, PcmPackage.COMPONENT_UNCERTAINTY_SOURCE__SCENARIOS);
		}
		return scenarios;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PcmPackage.COMPONENT_UNCERTAINTY_SOURCE__TARGET:
