 ...
 * </p>
 * <ul>
 *   <li>{@link dev.abunai.confidentiality.analysis.model.uncertainty.pcm.impl.ConnectorUncertaintySourceInEntryLevelSystemCallImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link dev.abunai.confidentiality.analysis.model.uncertainty.pcm.impl.ConnectorUncertaintySourceInEntryLevelSystemCallImpl#getScenarios <em>Scenarios</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConnectorUncertaintySourceInEntryLevelSystemCallImpl extends ConnectorUncertaintySourceImpl implements ConnectorUncertaintySourceInEntryLevelSystemCall {
	...
	protected EClass eStaticClass() {
		return PcmPackage.Literals.CONNECTOR_UNCERTAINTY_SOURCE_IN_ENTRY_LEVEL_SYSTEM_CALL;
	}
		...
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PcmPackage.CONNECTOR_UNCERTAINTY_SOURCE_IN_ENTRY_LEVEL_SYSTEM_CALL__TARGET, oldTarget, target));
			}
		}
		return target;
	}
	...
	public void setTarget(EntryLevelSystemCall newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PcmPackage.CONNECTOR_UNCERTAINTY_SOURCE_IN_ENTRY_LEVEL_SYSTEM_CALL__TARGET, oldTarget, target));
	}
	 ...
	 * @generated
	 */
	public List<ConnectorUncertaintyScenarioInEntryLevelSystemCall> getScenarios() {
		if (scenarios == null) {
			scenarios = new EObjectContainmentEList<ConnectorUncertaintyScenarioInEntryLevelSystemCall>(ConnectorUncertaintyScenarioInEntryLevelSystemCall.class, this, PcmPackage.CONNECTOR_UNCERTAINTY_SOURCE_IN_ENTRY_LEVEL_SYSTEM_CALL__SCENARIOS);
		}
		return scenarios;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PcmPackage.CONNECTOR_UNCERTAINTY_SOURCE_IN_ENTRY_LEVEL_SYSTEM_CALL__TARGET:
