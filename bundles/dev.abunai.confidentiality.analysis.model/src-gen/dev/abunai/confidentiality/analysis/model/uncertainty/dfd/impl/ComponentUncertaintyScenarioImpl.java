 ...
 * </p>
 * <ul>
 *   <li>{@link dev.abunai.confidentiality.analysis.model.uncertainty.dfd.impl.ComponentUncertaintyScenarioImpl#getTarget <em>Target</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ComponentUncertaintyScenarioImpl extends UncertaintyScenarioImpl implements ComponentUncertaintyScenario {
	...
	protected EClass eStaticClass() {
		return DfdPackage.Literals.COMPONENT_UNCERTAINTY_SCENARIO;
	}
		...
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DfdPackage.COMPONENT_UNCERTAINTY_SCENARIO__TARGET, oldTarget, target));
			}
		}
		return target;
	}
	...
	public void setTarget(Node newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DfdPackage.COMPONENT_UNCERTAINTY_SCENARIO__TARGET, oldTarget, target));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DfdPackage.COMPONENT_UNCERTAINTY_SCENARIO__TARGET:
