	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case UncertaintyPackage.UNCERTAINTY_SOURCE_COLLECTION: {
				...
				if (result == null) result = caseEntity(uncertaintySourceCollection);
				if (result == null) result = caseIdentifier(uncertaintySourceCollection);
				if (result == null) result = caseNamedElement(uncertaintySourceCollection);
			...
			case UncertaintyPackage.UNCERTAINTY_SOURCE: {
				...
				if (result == null) result = caseEntity(uncertaintySource);
				if (result == null) result = caseIdentifier(uncertaintySource);
				if (result == null) result = caseNamedElement(uncertaintySource);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case UncertaintyPackage.UNCERTAINTY_SCENARIO: {
				...
				if (result == null) result = caseEntity(uncertaintyScenario);
				if (result == null) result = caseIdentifier(uncertaintyScenario);
				if (result == null) result = caseNamedElement(uncertaintyScenario);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
