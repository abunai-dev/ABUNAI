 ...
 * </p>
 * <ul>
 *   <li>{@link dev.abunai.confidentiality.analysis.model.uncertainty.dfd.impl.ConnectorUncertaintySourceImpl#getTargetAssignement <em>Target Assignement</em>}</li>
 *   <li>{@link dev.abunai.confidentiality.analysis.model.uncertainty.dfd.impl.ConnectorUncertaintySourceImpl#getTargetFlow <em>Target Flow</em>}</li>
 *   <li>{@link dev.abunai.confidentiality.analysis.model.uncertainty.dfd.impl.ConnectorUncertaintySourceImpl#getScenarios <em>Scenarios</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConnectorUncertaintySourceImpl extends UncertaintySourceImpl implements ConnectorUncertaintySource {
	/**
	 ...
	 * @ordered
	 */
	protected EList<ConnectorUncertaintyScenario> scenarios;
	...
	protected EClass eStaticClass() {
		return DfdPackage.Literals.CONNECTOR_UNCERTAINTY_SOURCE;
	}
		...
		if (targetAssignement != null && targetAssignement.eIsProxy()) {
			...
			if (targetAssignement != oldTargetAssignement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DfdPackage.CONNECTOR_UNCERTAINTY_SOURCE__TARGET_ASSIGNEMENT, oldTargetAssignement, targetAssignement));
			}
		}
	...
	public void setTargetAssignement(AbstractAssignment newTargetAssignement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DfdPackage.CONNECTOR_UNCERTAINTY_SOURCE__TARGET_ASSIGNEMENT, oldTargetAssignement, targetAssignement));
	}
	...
	public Flow getTargetFlow() {
		if (targetFlow != null && targetFlow.eIsProxy()) {
			...
			if (targetFlow != oldTargetFlow) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DfdPackage.CONNECTOR_UNCERTAINTY_SOURCE__TARGET_FLOW, oldTargetFlow, targetFlow));
			}
		}
		return targetFlow;
	}
	...
	public void setTargetFlow(Flow newTargetFlow) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DfdPackage.CONNECTOR_UNCERTAINTY_SOURCE__TARGET_FLOW, oldTargetFlow, targetFlow));
	}
	 ...
	 * @generated
	 */
	public List<ConnectorUncertaintyScenario> getScenarios() {
		if (scenarios == null) {
			scenarios = new EObjectContainmentEList<ConnectorUncertaintyScenario>(ConnectorUncertaintyScenario.class, this, DfdPackage.CONNECTOR_UNCERTAINTY_SOURCE__SCENARIOS);
		}
		return scenarios;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DfdPackage.CONNECTOR_UNCERTAINTY_SOURCE__SCENARIOS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DfdPackage.CONNECTOR_UNCERTAINTY_SOURCE__TARGET_ASSIGNEMENT:
				if (resolve) return getTargetAssignement();
				return basicGetTargetAssignement();
			case DfdPackage.CONNECTOR_UNCERTAINTY_SOURCE__TARGET_FLOW:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case DfdPackage.CONNECTOR_UNCERTAINTY_SOURCE__SCENARIOS:
				getScenarios().clear();
				getScenarios().addAll((Collection<? extends ConnectorUncertaintyScenario>)newValue);
				return;
		}
