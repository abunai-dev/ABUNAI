 ...
 * </p>
 * <ul>
 *   <li>{@link dev.abunai.confidentiality.analysis.model.uncertainty.impl.ExternalUncertaintyScenarioInResourceImpl#getTarget <em>Target</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExternalUncertaintyScenarioInResourceImpl extends UncertaintyScenarioImpl implements ExternalUncertaintyScenarioInResource {
	...
	protected EClass eStaticClass() {
		return UncertaintyPackage.Literals.EXTERNAL_UNCERTAINTY_SCENARIO_IN_RESOURCE;
	}
		...
		if (target != null && ((EObject)target).eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UncertaintyPackage.EXTERNAL_UNCERTAINTY_SCENARIO_IN_RESOURCE__TARGET, oldTarget, target));
			}
		}
		return target;
	}
	...
	public void setTarget(RessourceAssignee newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UncertaintyPackage.EXTERNAL_UNCERTAINTY_SCENARIO_IN_RESOURCE__TARGET, oldTarget, target));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UncertaintyPackage.EXTERNAL_UNCERTAINTY_SCENARIO_IN_RESOURCE__TARGET:
