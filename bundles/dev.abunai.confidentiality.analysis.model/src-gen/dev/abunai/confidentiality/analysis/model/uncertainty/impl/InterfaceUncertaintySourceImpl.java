 ...
 * </p>
 * <ul>
 *   <li>{@link dev.abunai.confidentiality.analysis.model.uncertainty.impl.InterfaceUncertaintySourceImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link dev.abunai.confidentiality.analysis.model.uncertainty.impl.InterfaceUncertaintySourceImpl#getScenarios <em>Scenarios</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InterfaceUncertaintySourceImpl extends UncertaintySourceImpl implements InterfaceUncertaintySource {
	...
	protected EClass eStaticClass() {
		return UncertaintyPackage.Literals.INTERFACE_UNCERTAINTY_SOURCE;
	}
		...
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UncertaintyPackage.INTERFACE_UNCERTAINTY_SOURCE__TARGET, oldTarget, target));
			}
		}
		return target;
	}
	...
	public void setTarget(OperationSignature newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UncertaintyPackage.INTERFACE_UNCERTAINTY_SOURCE__TARGET, oldTarget, target));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UncertaintyPackage.INTERFACE_UNCERTAINTY_SOURCE__TARGET:
