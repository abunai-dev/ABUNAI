 ...
 * </p>
 * <ul>
 *   <li>{@link dev.abunai.confidentiality.analysis.model.uncertainty.impl.ConnectorUncertaintySourceInExternalCallImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link dev.abunai.confidentiality.analysis.model.uncertainty.impl.ConnectorUncertaintySourceInExternalCallImpl#getScenarios <em>Scenarios</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConnectorUncertaintySourceInExternalCallImpl extends ConnectorUncertaintySourceImpl implements ConnectorUncertaintySourceInExternalCall {
	...
	protected EClass eStaticClass() {
		return UncertaintyPackage.Literals.CONNECTOR_UNCERTAINTY_SOURCE_IN_EXTERNAL_CALL;
	}
		...
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UncertaintyPackage.CONNECTOR_UNCERTAINTY_SOURCE_IN_EXTERNAL_CALL__TARGET, oldTarget, target));
			}
		}
		return target;
	}
	...
	public void setTarget(ExternalCallAction newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UncertaintyPackage.CONNECTOR_UNCERTAINTY_SOURCE_IN_EXTERNAL_CALL__TARGET, oldTarget, target));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UncertaintyPackage.CONNECTOR_UNCERTAINTY_SOURCE_IN_EXTERNAL_CALL__TARGET:
