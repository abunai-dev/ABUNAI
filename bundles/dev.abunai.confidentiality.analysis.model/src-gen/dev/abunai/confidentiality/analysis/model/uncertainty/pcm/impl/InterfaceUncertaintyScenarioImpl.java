 ...
 * </p>
 * <ul>
 *   <li>{@link dev.abunai.confidentiality.analysis.model.uncertainty.pcm.impl.InterfaceUncertaintyScenarioImpl#getTarget <em>Target</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InterfaceUncertaintyScenarioImpl extends UncertaintyScenarioImpl implements InterfaceUncertaintyScenario {
	...
	protected EClass eStaticClass() {
		return PcmPackage.Literals.INTERFACE_UNCERTAINTY_SCENARIO;
	}
		...
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PcmPackage.INTERFACE_UNCERTAINTY_SCENARIO__TARGET, oldTarget, target));
			}
		}
		return target;
	}
	...
	public void setTarget(OperationSignature newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PcmPackage.INTERFACE_UNCERTAINTY_SCENARIO__TARGET, oldTarget, target));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PcmPackage.INTERFACE_UNCERTAINTY_SCENARIO__TARGET:
