 ...
 * </p>
 * <ul>
 *   <li>{@link dev.abunai.confidentiality.analysis.model.uncertainty.dfd.impl.InterfaceUncertaintyScenarioImpl#getTargetInPin <em>Target In Pin</em>}</li>
 *   <li>{@link dev.abunai.confidentiality.analysis.model.uncertainty.dfd.impl.InterfaceUncertaintyScenarioImpl#getTargetFlow <em>Target Flow</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InterfaceUncertaintyScenarioImpl extends UncertaintyScenarioImpl implements InterfaceUncertaintyScenario {
	...
	protected EClass eStaticClass() {
		return DfdPackage.Literals.INTERFACE_UNCERTAINTY_SCENARIO;
	}
		...
		if (targetInPin != null && targetInPin.eIsProxy()) {
			...
			if (targetInPin != oldTargetInPin) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DfdPackage.INTERFACE_UNCERTAINTY_SCENARIO__TARGET_IN_PIN, oldTargetInPin, targetInPin));
			}
		}
		return targetInPin;
	}
	...
	public void setTargetInPin(Pin newTargetInPin) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DfdPackage.INTERFACE_UNCERTAINTY_SCENARIO__TARGET_IN_PIN, oldTargetInPin, targetInPin));
	}
	...
	public Flow getTargetFlow() {
		if (targetFlow != null && targetFlow.eIsProxy()) {
			...
			if (targetFlow != oldTargetFlow) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DfdPackage.INTERFACE_UNCERTAINTY_SCENARIO__TARGET_FLOW, oldTargetFlow, targetFlow));
			}
		}
		return targetFlow;
	}
	...
	public void setTargetFlow(Flow newTargetFlow) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DfdPackage.INTERFACE_UNCERTAINTY_SCENARIO__TARGET_FLOW, oldTargetFlow, targetFlow));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DfdPackage.INTERFACE_UNCERTAINTY_SCENARIO__TARGET_IN_PIN:
				if (resolve) return getTargetInPin();
				return basicGetTargetInPin();
			case DfdPackage.INTERFACE_UNCERTAINTY_SCENARIO__TARGET_FLOW:
