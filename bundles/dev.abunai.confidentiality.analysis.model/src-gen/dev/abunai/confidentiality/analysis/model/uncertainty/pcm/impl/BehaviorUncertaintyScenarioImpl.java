 ...
 * </p>
 * <ul>
 *   <li>{@link dev.abunai.confidentiality.analysis.model.uncertainty.pcm.impl.BehaviorUncertaintyScenarioImpl#getTarget <em>Target</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BehaviorUncertaintyScenarioImpl extends UncertaintyScenarioImpl implements BehaviorUncertaintyScenario {
	...
	protected EClass eStaticClass() {
		return PcmPackage.Literals.BEHAVIOR_UNCERTAINTY_SCENARIO;
	}
		...
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PcmPackage.BEHAVIOR_UNCERTAINTY_SCENARIO__TARGET, oldTarget, target));
			}
		}
		return target;
	}
	...
	public void setTarget(SetVariableAction newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PcmPackage.BEHAVIOR_UNCERTAINTY_SCENARIO__TARGET, oldTarget, target));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PcmPackage.BEHAVIOR_UNCERTAINTY_SCENARIO__TARGET:
