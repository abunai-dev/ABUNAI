...
/**
 * This is the item provider adapter for a {@link dev.abunai.confidentiality.analysis.model.uncertainty.Scenario} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ScenarioItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Scenario_probability_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Scenario_probability_feature", "_UI_Scenario_type"),
				 UncertaintyPackage.Literals.SCENARIO__PROBABILITY,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Scenario_type") + " " + scenario.getProbability();
	}
